                ...
                <form class="" action="<?= base_url('login/salvar'); ?>" method="POST">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputAddressCep" name="cep" id="cep" value="<?= set_value('cep'); ?>" required>
                            <?php
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputAddressRua" name="rua" id="rua" value="<?= set_value('rua'); ?>" required>
                            <?php
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="inputCity" name="cidade" id="cidade" value="<?= set_value('cidade'); ?>" required>
                                    <?php
